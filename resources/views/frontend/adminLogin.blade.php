            ...
            <div class="row">
                <div class=" search ui-widget">  
                   @if(Auth::check())
                      ...
                      <a class="login" href="{{ url('/dashboard') }}" style="font-size: 25px;">Dashboaerd </a>
...
<style type="text/css">
    ...
    .login{
            background: url({{ asset("uploads/04.png") }});
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="login-form text-center v-middle">
            ...
            <div>
       {!! Form::open( array('url' => array('authenticate' ), 'id'=> 'login_form','method'=>'POST'))  !!}
