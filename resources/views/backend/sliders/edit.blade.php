...
@section('page_title' , trans('Edit slider'))

@section('breadcrumb')


                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">{{ trans('Edit slider') }}</h4> 
                    </div>
...
@section('content')
                    ...
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <p class="text-muted m-b-30 font-13">{{ trans('Edit slider') }}</p>
                            <div class="row">
                                <div class="col-md-12">
                                {!! Form::model($slider, array('route' => array('slider.update', $slider->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST'))  !!}
                                        {!! method_field('put') !!}

                                        <div class="form-group ">
                                            <label class="col-md-12">{{ trans('English Name') }}</label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="{{ trans('English Name') }}" name="Name" value="{{ $slider->name }}" class="form-control form-control-line"> </div>
                                        </div><br><br>

                                    <div class="form-group ">
                                            <label class="col-md-12">{{ trans('Arabic Name') }}</label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="{{ trans('Arabic Name') }}" name="name_ar" value="{{ $slider->name_ar }}" class="form-control form-control-line"> </div>
                                        </div><br><br>
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description"
                                                     placeholder="{{ trans('English description') }}">{{$slider->description}} </textarea> 
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description_ar"
                                                     placeholder="{{ trans('Arabic description') }}">{{$slider->description_ar}} </textarea> 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                     ...
                                                     <input type="checkbox" name="status" {!! $slider->status == 'active' ? 'checked' : '' !!}  class="js-switch" data-color="#99d683" />
