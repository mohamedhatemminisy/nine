...
@section('page_title' , trans('Show sliders'))

@section('breadcrumb')


                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">{{ trans('Show sliders') }}</h4> 
                    </div>
        ...
        <table class="table" border="2" id="myTable">
            ...
            <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <td class="text-nowrap">
                                ...
                                <a  href="{{ route('slider.edit' , $slider->id) }}" data-toggle="tooltip" data-original-title="{{ trans('backend.edit') }}"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                ...
                                {!! Form::open(['route'=>["slider.destroy" , $slider->id ] , 'class'=>"social_form_$slider->id" ]) !!}
                ...
                @else
    				...
    				<tr>
    					<td colspan="7" class="text-center">{{ trans('No sliders') }}</td>
    				</tr>
