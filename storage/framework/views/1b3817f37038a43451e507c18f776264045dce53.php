...
<?php $__env->startSection('breadcrumb'); ?>
					...
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.show_advices')); ?></h4>
                    </div>
    ...
    <div class="table-responsive">
        <table class="table   table-hover color-table table-bordered primary-table">
            <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo e(trans('backend.advice_title')); ?></th>
                    <th><?php echo e(trans('backend.advice_description')); ?></th>
                    <th><?php echo e(trans('backend.advice_owner')); ?></th>
                    <th><?php echo e(trans('backend.advice_photo')); ?></th>
            ...
            <tbody>
                ...
                <?php else: ?>
    				...
    				<tr>
    					<td colspan="7" class="text-center"><?php echo e(trans('backend.advice_no_messages')); ?></td>
    				</tr>
