            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <section class="m-t-40">
                       ...
                       <?php echo Form::open(['route'=>['careers.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true ,
                       'id'=>'add_files']); ?>
                        ...
                        <div class="form-group  col-md-12">
                            <label for=""><?php echo e(trans('backend.careers_name')); ?></label>
                            <div class="input-group">

                                <input type="text" class="form-control" name="name"
                                       value=""
                                       id="name" placeholder="<?php echo e(trans('backend.careers_name')); ?>">
                    ...
                    <div class="form-group  col-md-12">
                        <label for=""><?php echo e(trans('backend.careers_decription')); ?></label>
                        <div class="input-group">

                            <input type="text" class="form-control" name="description"
                                   value=""
                                   id="decription" placeholder="<?php echo e(trans('backend.careers_decription')); ?>">
