...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <section class="m-t-40">
                       ...
                       <?php echo Form::open(['route'=>['product.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true ,
                       'id'=>'add_files']); ?>
                        ...
                        <div class="form-group  col-md-12">
                            <label for=""><?php echo e(trans('backend.product_name')); ?></label>
                            <div class="input-group">

                                <input type="text" class="form-control" name="name"
                                       value=""
                                       id="name" placeholder="<?php echo e(trans('backend.product_name')); ?>">
                    ...
                    <div class="form-group  col-md-12">
                        <label for=""><?php echo e(trans('backend.product_decription')); ?></label>
                        <div class="input-group">

                            <input type="text" class="form-control" name="description"
                                   value=""
                                   id="decription" placeholder="<?php echo e(trans('backend.product_decription')); ?>">
        ...
        <div class="form-group">
            ...
            <label for=" ">&nbsp;&nbsp;&nbsp; <?php echo e(trans('backend.catogrie')); ?></label>
            <div class="col-md-12">
            ...
            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <!-- simple check on language -->
                                ...
                                <option value="<?php echo e($cat->id); ?>" data-tokens="ketchup mustard"><?php echo e($cat->name); ?></option >
