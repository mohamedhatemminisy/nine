                            ...
                            <div class="row">
                                ...
                                <?php echo Form::model($slider, array('route' => array('slider.update', $slider->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST')); ?>
                                        ...
                                        <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans(' Name')); ?></label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans(' Name')); ?>" name="Name" value="<?php echo e($slider->name); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description"
                                                     placeholder="<?php echo e(trans('description')); ?>"><?php echo e($slider->description); ?> </textarea> 
