...
<?php $__env->startSection('breadcrumb'); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.activity_rate')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
				 ...
				 <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> <?php echo e(trans('backend.editing_activity_rate')); ?> </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                   

                                   <?php echo Form::model( $activityGrades ,  ['route'=>['activity_rate.update' , $activityGrades->id ] , 'method'=>'POST' , 'files'=>True ]); ?>
                                        ...
                                        <select class="selectpicker m-b-20 m-r-10" name="adv_type"          data-style="btn-primary btn-outline">
                                            ...
                                            <?php $__currentLoopData = $child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <option value="<?php echo e($ch->id); ?>" 
                                                    <?php echo $ch->id == $activityGrades->child_id ? 'selected' : ''; ?> data-tokens="ketchup mustard"><?php echo e($ch->name); ?></option >
                                ...
                                <div class="form-group col-md-12">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <input type="text" class="form-control" name="child_status"  value="<?php echo e($activityGrades->grade); ?>"
                              ...
                              <div class="form-group col-md-12">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <textarea type="text" class="form-control" name="status_description"
                                                     placeholder="<?php echo e(trans('backend.advice_status_description')); ?>"> <?php echo e($activityGrades->description); ?></textarea> 
