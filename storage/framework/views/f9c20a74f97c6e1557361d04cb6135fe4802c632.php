...
<?php $__env->startSection('page_title' , trans('Edit user')); ?>

<?php $__env->startSection('breadcrumb'); ?>


                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('Edit user')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <p class="text-muted m-b-30 font-13"><?php echo e(trans('Edit user')); ?></p>
                            <div class="row">
                                <div class="col-md-12">
                                <?php echo Form::model($user, array('route' => array('user.update', $user->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST')); ?>
                                        ...
                                        <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans('First Name')); ?></label><br><br>
                                            <div class="col-md-12">
                                          ...
                                          <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans('Last Name')); ?></label><br><br>
                                            <div class="col-md-12">
                                             ...
                                             <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans('Phone')); ?></label><br><br>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><?php echo e(trans('Email')); ?></label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('Email')); ?>" name="user_email" value="<?php echo e($user->email); ?>" class="form-control form-control-line"> </div><br><br>
                                        </div>
