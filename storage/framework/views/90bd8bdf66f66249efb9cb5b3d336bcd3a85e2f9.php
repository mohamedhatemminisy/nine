                                        ...
                                        <div class="form-group ">
                                         ...
                                         <label class="col-md-12"><?php echo e(trans('English Name')); ?></label>
                                            ...
                                            <div class="col-md-12">
                                                      ...
                                                      <input type="text" placeholder="<?php echo e(trans(' English Name')); ?>" name="memberName"   class="form-control form-control-line"> 
                                         ...
                                         <label class="col-md-12"><?php echo e(trans('career in arabic')); ?></label>
                                                   

                                            <div class="col-md-12">
 
                                                      <input type="text" placeholder="<?php echo e(trans('career in arabic')); ?>" name="career"   class="form-control form-control-line"> 
                                         ...
                                         <label class="col-md-12"><?php echo e(trans('career in english')); ?></label>
                                                   

                                            <div class="col-md-12">
 
                                                      <input type="text" placeholder="<?php echo e(trans('career in english')); ?>" name="carrer_ar"   class="form-control form-control-line"> 
