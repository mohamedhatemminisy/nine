...
<?php $__env->startSection('breadcrumb'); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.create_evaluation_rate')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="col-sm-12">
              <div class="white-box">
                  ...
                  <p class="text-muted m-b-30 font-13"> <?php echo e(trans('backend.create_evaluation_rate')); ?> </p>
                  <div class="row">
                      <div class="col-sm-12 col-xs-12">
                         <section class="m-t-40">
                          <div class="sttabs tabs-style-iconbox">

                      <?php echo Form::open(['route'=>['evaluation_rate.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true , 'id'=>'add_option']); ?>
