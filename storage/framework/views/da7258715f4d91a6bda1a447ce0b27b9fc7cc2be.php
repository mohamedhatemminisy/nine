                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <a href="#" class="waves-effect ">
                            ...
                            <span class="hide-menu"><?php echo e(trans(' Tasks ')); ?>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo e(url('tasks')); ?>"><?php echo e(trans('Show Tasks')); ?></a></li>
                        </ul>
                     ...
                     <li>
                        ...
                        <a href="#" class="waves-effect ">
                            <i class="fa  fa-mail-forward"></i>
                            <span class="hide-menu"><?php echo e(trans(' Tasks reports ')); ?>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo e(url('tasksReports')); ?>"><?php echo e(trans('Show Tasks Reports')); ?></a></li>
                        </ul>
                     ...
                     <li>
                        ...
                        <a href="#" class="waves-effect ">
                            <i class="fa  fa-mail-forward"></i>
                            <span class="hide-menu"><?php echo e(trans('Attendance')); ?>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?php echo e(url('employeeAttendance')); ?>"><?php echo e(trans('Show Emoployee Attendance')); ?></a></li>
                        </ul>
