        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> 
                        ...
                        <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/advert_type"   ? 'active' : ''; ?>  
                            <?php echo Request::path() == "$lang/advert_type/create"   ? 'active' : ''; ?>  ">
                            <i class="fa fa-paper-plane"></i> 
                            <span class="hide-menu"> <?php echo e(trans('advert.advert_type')); ?> 
                                <span class="fa arrow"></span>  
                            </span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo e(route('advType.create')); ?>"><?php echo e(trans('advert.create_advert_type')); ?></a> </li>
                            <li> <a href="<?php echo e(route('advType.index')); ?>"><?php echo e(trans('advert.show_advert_types')); ?></a> </li>
                    ...
                    <li> 
                        ...
                        <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/adverts"   ? 'active' : ''; ?>  
                            <?php echo Request::path() == "$lang/adverts/create"   ? 'active' : ''; ?>  ">
                            <i class="fa fa-bullhorn"></i> 
                            <span class="hide-menu"> <?php echo e(trans('advert.adverts')); ?> 
                                <span class="fa arrow"></span>  
                            </span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo e(route('adverts.create')); ?>"><?php echo e(trans('advert.create_adverts')); ?></a> </li>
                            <li> <a href="<?php echo e(route('adverts.index')); ?>"><?php echo e(trans('advert.show_adverts')); ?></a> </li>
                    ...
                    <li> 
                        ...
                        <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/comments"   ? 'active' : ''; ?>  
                            ...
                            <span class="hide-menu"> <?php echo e(trans('advert.comments')); ?> 
                                <span class="fa arrow"></span>  
                            </span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo e(route('comments.index')); ?>"><?php echo e(trans('advert.show_commentss')); ?></a> </li>
