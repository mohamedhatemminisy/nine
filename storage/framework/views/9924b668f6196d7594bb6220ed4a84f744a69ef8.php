...
<?php $__env->startSection('breadcrumb'); ?>
					...
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.show_evaluation_rate')); ?></h4>
                    </div>
            		...
            		<?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <a  href="<?php echo e(route('evaluation_rate.edit' , $grade->id)); ?>" data-toggle="tooltip" data-original-title="<?php echo e(trans('backend.edit')); ?>"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                   ...
                                   <?php echo Form::open(['route'=>["evaluation_rate.destroy" , $grade->id ] , 'class'=>"advice_form_$grade->id" ]); ?>
