                ...
                <div class="col-sm-12 col-xs-12">
                    <section class="m-t-40">
                        <div class="sttabs tabs-style-iconbox">
                            ...
                            <?php echo Form::model($partner , ['route'=>['partners.update',$partner->id],
                    ...
                    <div class="form-group col-md-12">
                        <label for="">
                        &nbsp; <?php echo e(trans('backend.partners_name')); ?></label>
                        <div class="input-group">
                           ...
                           &nbsp; &nbsp; &nbsp;
                            <input type="text" class="form-control" name="name"
                                   ...
                                   placeholder="<?php echo e(trans('backend.partners_name')); ?>">
                    ...
                    <div class="form-group col-md-12">
                        <label for="">
                        &nbsp; <?php echo e(trans('backend.partners_decription')); ?></label>
                        <div class="input-group">


                           &nbsp; &nbsp; &nbsp;
                            <input type="text" class="form-control" name="description"
                                   value="<?php echo e($partner->description); ?>"

                                   placeholder="<?php echo e(trans('backend.partners_decription')); ?>">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                &nbsp; &nbsp; &nbsp;
                                                <input <?php  echo $partner->status=='active' ? 'checked':''; ?> type="checkbox" name="status"  class="js-switch" data-color="#99d683" />
                                            </div>
