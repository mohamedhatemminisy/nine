                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                   ...
                                   <?php echo Form::model( $activities ,  ['route'=>['activity.update' , $activities->id ] , 'method'=>'POST' , 'files'=>True ]); ?>
                              ...
                              <div class="form-group col-md-12">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <textarea type="text" class="form-control" name="question"
                                                     placeholder="<?php echo e(trans('backend.question')); ?>"> <?php echo e($activities->question); ?></textarea> 
