            ...
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <?php echo Form::model( $about ,  ['route'=>['about_update' , $about->id],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true , 'id'=>'article_update']); ?>
                              ...
                              <div class="form-group col-md-12">
                                          <label for=""><?php echo e(trans('content')); ?></label>  
                                          <div class="input-group">

                                              <textarea type="text" class="form-control" " name="conten"
                                                     placeholder="<?php echo e(trans('content')); ?>"><?php echo e($about->conten); ?> </textarea> 
     
                                          </div>
                               </div>

                              <div class="form-group col-md-12">
                                          <label for=""><?php echo e(trans('history')); ?></label>  
                                          <div class="input-group">

                                              <textarea type="text" class="form-control" " name="history"
                                                     placeholder="<?php echo e(trans('history')); ?>"><?php echo e($about->history); ?> </textarea> 
                                ...
                                <div class="form-group col-md-12">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <textarea type="text" class="form-control" " name="description"
                                                     placeholder="<?php echo e(trans('description')); ?>"><?php echo e($about->description); ?> </textarea> 
     
                                          </div>
                               </div>   

                                <div class="form-group col-md-12">
                                          <label for=""><?php echo e(trans('defination')); ?></label>  
                                          <div class="input-group">

                                              <textarea type="text" class="form-control" " name="defination"
                                                     placeholder="<?php echo e(trans('defination')); ?>"><?php echo e($about->defination); ?> </textarea> 
