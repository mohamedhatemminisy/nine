                            ...
                            <div class="row">
                                ...
                                <?php echo Form::model($service, array('route' => array('service.update', $service->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST')); ?>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('English Name')); ?>" name="Name" value="<?php echo e($service->name); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>
                                         ...
                                         <div class="form-group ">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('Arabic Name')); ?>" name="name_ar" value="<?php echo e($service->name_ar); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description"
                                                     placeholder="<?php echo e(trans('English description')); ?>"><?php echo e($service->description); ?> </textarea> 
                                ...
                                <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description_ar"
                                                     placeholder="<?php echo e(trans('Arabic description')); ?>"><?php echo e($service->description_ar); ?> </textarea> 
