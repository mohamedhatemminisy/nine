                            ...
                            <div class="row">
                                ...
                                <?php echo Form::model($user, array('route' => array('user.update', $user->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST')); ?>
                                        ...
                                        <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans('backend.user_head_person')); ?></label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('backend.user_head_person')); ?>" name="user_head_person" value="<?php echo e($user->Fname); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>
