...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30 font-13"> <?php echo e(trans('backend.careers')); ?> </p>
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <section class="m-t-40">
                        <div class="sttabs tabs-style-iconbox">
                            ...
                            <?php echo Form::model($careers , ['route'=>['careers.update',$careers->id],
                    ...
                    <div class="form-group col-md-12">
                        <label for="">
                        &nbsp; <?php echo e(trans('backend.careers_name')); ?></label>
                        <div class="input-group">


                           &nbsp; &nbsp; &nbsp;
                            <input type="text" class="form-control" name="name"
                                   value="<?php echo e($careers->name); ?>"

                                   placeholder="<?php echo e(trans('backend.careers_name')); ?>">
                    ...
                    <div class="form-group col-md-12">
                        <label for="">
                        &nbsp; <?php echo e(trans('backend.careers_decription')); ?></label>
                        <div class="input-group">


                           &nbsp; &nbsp; &nbsp;
                            <input type="text" class="form-control" name="description"
                                   value="<?php echo e($careers->description); ?>"

                                   placeholder="<?php echo e(trans('backend.careers_decription')); ?>">
                                ...
                                <div class="form-group ">
                                    ...
                                    <label for=" ">  &nbsp; <?php echo e(trans('backend.careers_image')); ?></label>
                                    <div class="col-md-12">
                                        <div class="white-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                &nbsp; &nbsp; &nbsp;
                                                <input <?php  echo $careers->status=='active' ? 'checked':''; ?> type="checkbox" name="status"  class="js-switch" data-color="#99d683" />
                                            </div>
