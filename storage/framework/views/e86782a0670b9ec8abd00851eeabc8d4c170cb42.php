...
<?php $__env->startSection('content'); ?>
         ...
         <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> <?php echo e(trans('تعديل الخبر')); ?> </p>
                            <div class="row">
                              ...
                              <div class="form-group col-md-12">
                                          ...
                                          <textarea type="text" class="form-control" name="advice_description"
                                                     placeholder="<?php echo e(trans('وصف الخبر')); ?>"><?php echo e($advice->description); ?> </textarea> 
                         ...
                         <div class="form-group">
                              <label for=" "> &nbsp; <?php echo e(trans('اضافة الخبر الي')); ?></label>
                           <p>   الاخبار العاجلة &nbsp;&nbsp;&nbsp; &nbsp;الاكثر قراءة
                              <div class="col-md-12">
                                  &nbsp; &nbsp; &nbsp;
                                  <input <?php  echo $advice->type=='Urgent' ? 'checked':''; ?> type="checkbox" name="news_type"  class="js-switch" data-color="#99d683" />
                              </div>
