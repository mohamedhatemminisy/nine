...
<head>
  ...
  <title>Hello, world!</title>
   ...
   <link href="<?php echo e(asset('frontend/assets/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css"/>
     <link href="<?php echo e(asset('frontend/assets/css/slick.css')); ?> " rel="stylesheet" type="text/css"/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-right">
                    <a href="<?php echo e($header->Facebook); ?>" target="_blank" class="social-top"><i class="fa fa-facebook fa-fw"></i></a>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link contact-bag" href="<?php echo e(url("/contact_seccion")); ?>">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
