    ...
    <div class="container">
           ...
           <div class="row center-form">
                ...
                <div class="col-sm-4">
                        ...
                        <a href="<?php echo e(url('/')); ?>" class="btn btn-form back-btn">الرجوع الى الصفحة الرئيسية</a>

                </div>
           </div>
           <h4>قم بملىء البيانات المطلوبة</h4>
            <?php echo Form::open( array('url' => array('register' ), 'class'=>'bounceIn all-form' , 'data-wow-duration'=>'2s' , 'data-wow-offset'=>'0' , 'id'=> 'register_form','method'=>'POST')); ?>
