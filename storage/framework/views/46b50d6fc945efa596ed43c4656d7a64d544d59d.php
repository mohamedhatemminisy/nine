    ...
    <div class="table-responsive">
        <table class="table   table-hover color-table table-bordered primary-table">
            ...
            <tbody>
            	...
            	<?php if($contact->count()): ?>
            		  
            		<?php $__currentLoopData = $contact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visitorsMessage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                   ...
                                   <?php echo Form::open(['route'=>["Contact.destroy" , $visitorsMessage->id ] , 'class'=>"type_form_$visitorsMessage->id" ]); ?>
