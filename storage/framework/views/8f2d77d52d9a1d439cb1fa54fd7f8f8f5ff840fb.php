<?php $__env->startSection('page_title' , trans('Edit slider')); ?>

<?php $__env->startSection('breadcrumb'); ?>


                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('Edit slider')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <p class="text-muted m-b-30 font-13"><?php echo e(trans('Edit slider')); ?></p>
                            <div class="row">
                                <div class="col-md-12">
                                <?php echo Form::model($slider, array('route' => array('slider.update', $slider->id) , 'class'=> 'form-horizontal form-material' , 'files'=>true , 'method'=>'POST')); ?>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('English Name')); ?>" name="Name" value="<?php echo e($slider->name); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>

                                    <div class="form-group ">
                                            <label class="col-md-12"><?php echo e(trans('Arabic Name')); ?></label><br><br>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="<?php echo e(trans('Arabic Name')); ?>" name="name_ar" value="<?php echo e($slider->name_ar); ?>" class="form-control form-control-line"> </div>
                                        </div><br><br>
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description"
                                                     placeholder="<?php echo e(trans('English description')); ?>"><?php echo e($slider->description); ?> </textarea> 
                               ...
                               <div class="form-group">
                                          ...
                                          <textarea type="text" class="form-control" name="description_ar"
                                                     placeholder="<?php echo e(trans('Arabic description')); ?>"><?php echo e($slider->description_ar); ?> </textarea> 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                     ...
                                                     <input type="checkbox" name="status" <?php echo $slider->status == 'active' ? 'checked' : ''; ?>  class="js-switch" data-color="#99d683" />
