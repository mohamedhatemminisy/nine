        ...
        <table class="table   table-hover table-bordered color-table primary-table">
            <thead>
                                      <tr>
                                          ...
                                          <th><?php echo e(trans('backend.user_type')); ?></th>
                           ...
                           <td>
                             ...
                             <td>
                                <?php if($user->role == 'admin'): ?>
                                    <span class="label label-danger"><?php echo e(trans('backend.admin')); ?></span>
                                <?php elseif($user->role == 'teacher'): ?>
                                    <span class="label label-success"><?php echo e(trans('backend.teacher')); ?></span>  
                                      <?php else: ?>
                                    <span class="label label-primary"><?php echo e(trans('backend.user')); ?></span>
                                <?php endif; ?>
                            </td>
