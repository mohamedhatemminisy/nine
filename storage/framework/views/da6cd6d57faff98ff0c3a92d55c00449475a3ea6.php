<?php $__env->startSection('page_title' , trans('advert.comments')); ?>

<?php $__env->startSection('breadcrumb'); ?>


                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('advert.show_commentss')); ?></h4> 
                    </div>
        ...
        <table class="table   table-hover table-bordered color-table primary-table">
            <thead>
                                      <tr>
                                            ...
                                            <th><?php echo e(trans('advert.comment')); ?></th>
                                            <th><?php echo e(trans('advert.coment_owner')); ?></th>
                                            <th><?php echo e(trans('advert.advert')); ?></th>
                             ...
                             <td>
                                <?php if($lang == "ar"): ?>
                                    <?php echo e($comment->advert->title_ar); ?>

                                <?php else: ?>
                                    <?php echo e($comment->advert->title_en); ?>
                                ...
                                <?php endif; ?>
                                   ...
                                   <?php echo Form::close(); ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <tr>
                                                <td colspan="6" class="text-center"><?php echo e(trans('advert.comment_count_zero')); ?></td>
                                            </tr>
