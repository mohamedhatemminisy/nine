...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.create_activity')); ?></h4> 
                    </div>
  ...
  <div class="col-sm-12">
              <div class="white-box">
                  ...
                  <p class="text-muted m-b-30 font-13"> <?php echo e(trans('backend.create_activity')); ?> </p>
                  <div class="row">
                      ...
                      <?php echo Form::open(['route'=>['activity.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true , 'id'=>'add_option']); ?>
        ...
        jQuery(document).ready(function() {
         ...
         $('.dropify').dropify({
            tpl: {
                ...
                message:         '<div class="dropify-message"><span class="file-icon" /> <p><?php echo e(trans("backend.activity_photos")); ?></p></div>',
                preview:         '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message"><?php echo e(trans("backendbackend.activity_photos")); ?></p></div></div></div>',
