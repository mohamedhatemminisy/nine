        ...
        <table class="table" border="2" id="myTable">
            <thead>
                                      <tr>
                                            ...
                                            <th><?php echo e(trans('career in arabic')); ?></th>
                                            <th><?php echo e(trans('career in english')); ?></th>
            	...
            	<?php if($teams->count()): ?>
            		...
            		<?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($team->carrer_ar); ?></td>
                            <td><?php echo e($team->career); ?></td>
                            <td><?php echo e($team->name_ar); ?></td>
                            <td><?php echo e($team->name); ?></td>
                            <td><?php echo e($team->description_ar); ?></td>
