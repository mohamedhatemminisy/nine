            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <section class="m-t-40">
                       ...
                       <?php echo Form::open(['route'=>['news.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true ,
                       'id'=>'add_files']); ?>
                        ...
                        <div class="form-group  col-md-12">
                            <label for=""><?php echo e(trans('backend.news_name')); ?></label>
                            <div class="input-group">

                                <input type="text" class="form-control" name="name"
                                       value=""
                                       id="name" placeholder="<?php echo e(trans('backend.news_name')); ?>">
                    ...
                    <div class="form-group  col-md-12">
                        <label for=""><?php echo e(trans('backend.news_decription')); ?></label>
                        <div class="input-group">

                            <input type="text" class="form-control" name="description"
                                   value=""
                                   id="decription" placeholder="<?php echo e(trans('backend.news_decription')); ?>">
