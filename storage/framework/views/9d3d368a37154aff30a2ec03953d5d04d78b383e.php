            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> 
                        ...
                        <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/language"   ? 'active' : ''; ?>  
                            <?php echo Request::path() == "$lang/language/create"   ? 'active' : ''; ?>  ">
                            <i class="fa fa-language"></i> 
                            <span class="hide-menu"> <?php echo e(trans('backend.catogrie')); ?> 
                                <span class="fa arrow"></span>  
                            </span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo e(route('catogrie.create')); ?>"><?php echo e(trans('backend.create_cat')); ?></a> </li>
                            <li> <a href="<?php echo e(route('catogrie.index')); ?>"><?php echo e(trans('backend.show_cat')); ?></a> </li>
        ...
        <li> 
            ...
            <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/language"   ? 'active' : ''; ?>  
                <?php echo Request::path() == "$lang/language/create"   ? 'active' : ''; ?>  ">
                <i class="fa fa-language"></i> 
                <span class="hide-menu"> <?php echo e(trans('backend.product')); ?> 
                    <span class="fa arrow"></span>  
                </span>
            </a>
            <ul class="nav nav-second-level">
                <li> <a href="<?php echo e(route('product.create')); ?>"><?php echo e(trans('backend.create_product')); ?></a> </li>
                <li> <a href="<?php echo e(route('product.index')); ?>"><?php echo e(trans('backend.show_product')); ?></a> </li>
        ...
        <li> 
            ...
            <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/language"   ? 'active' : ''; ?>  
                <?php echo Request::path() == "$lang/language/create"   ? 'active' : ''; ?>  ">
                <i class="fa fa-language"></i> 
                <span class="hide-menu"> <?php echo e(trans('backend.news')); ?> 
                    <span class="fa arrow"></span>  
                </span>
            </a>
            <ul class="nav nav-second-level">
                <li> <a href="<?php echo e(route('news.create')); ?>"><?php echo e(trans('backend.create_news')); ?></a> </li>
                <li> <a href="<?php echo e(route('news.index')); ?>"><?php echo e(trans('backend.show_news')); ?></a> </li>
        ...
        <li> 
            ...
            <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/language"   ? 'active' : ''; ?>  
                <?php echo Request::path() == "$lang/language/create"   ? 'active' : ''; ?>  ">
                <i class="fa fa-language"></i> 
                <span class="hide-menu"> <?php echo e(trans('backend.partners')); ?> 
                    <span class="fa arrow"></span>  
                </span>
            </a>
            <ul class="nav nav-second-level">
                <li> <a href="<?php echo e(route('partners.create')); ?>"><?php echo e(trans('backend.create_partners')); ?></a> </li>
                <li> <a href="<?php echo e(route('partners.index')); ?>"><?php echo e(trans('backend.show_partners')); ?></a> </li>
        ...
        <li> 
            ...
            <ul class="nav nav-second-level">
                <li> <a href="<?php echo e(route('careers.create')); ?>"><?php echo e(trans('backend.create_careers')); ?></a> </li>
                <li> <a href="<?php echo e(route('careers.index')); ?>"><?php echo e(trans('backend.show_careers')); ?></a> </li>
        ...
        <li> 
            ...
            <a href="#" class="waves-effect  <?php echo Request::path() == "$lang/language"   ? 'active' : ''; ?>  
                <?php echo Request::path() == "$lang/language/create"   ? 'active' : ''; ?>  ">
                <i class="fa fa-language"></i> 
                <span class="hide-menu"> <?php echo e(trans('backend.testimonials')); ?> 
                    <span class="fa arrow"></span>  
                </span>
            </a>
            <ul class="nav nav-second-level">
                <li> <a href="<?php echo e(route('testimonials.create')); ?>"><?php echo e(trans('backend.create_testimonials')); ?></a> </li>
                <li> <a href="<?php echo e(route('testimonials.index')); ?>"><?php echo e(trans('backend.show_testimonials')); ?></a> </li>
