...
<?php $__env->startSection('breadcrumb'); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('backend.create_message')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="col-sm-12">
              <div class="white-box">
                  ...
                  <p class="text-muted m-b-30 font-13"> <?php echo e(trans('backend.create_message')); ?> </p>
                  <div class="row">
                      <div class="col-sm-12 col-xs-12">
                         <section class="m-t-40">
                          <div class="sttabs tabs-style-iconbox">

                      <?php echo Form::open(['route'=>['message.store'],'method'=>'POST','class'=>'form-horizontal ','role'=>'form','files'=> true , 'id'=>'add_option']); ?>
                              ...
                              <div class="form-group col-md-12">
                                          ...
                                          <div class="input-group">
                                              <textarea type="text" class="form-control" name="message"
                                                     placeholder="<?php echo e(trans('backend.message')); ?>"> </textarea> 
                                   ...
                                   <div class="col-md-12">
                                        <select class="selectpicker m-b-20 m-r-10" name="message_reciver" data-style="btn-primary btn-outline">
                                            <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $us): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <option value="<?php echo e($us->id); ?>" data-tokens="ketchup mustard"><?php echo e($us->Fname); ?> <?php echo e($us->Lname); ?></option >
