<?php $__env->startSection('page_title' , trans('create photo')); ?>

<?php $__env->startSection('breadcrumb'); ?>

					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo e(trans('create new photo')); ?></h4> 
                    </div>
...
<?php $__env->startSection('content'); ?>
     ...
     <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            ...
                            <p class="text-muted m-b-30 font-13"><?php echo e(trans('create photo')); ?></p>
                            <div class="row">
                                <div class="col-md-12">
                                     

                                     <?php echo Form::open( array('route' => array('gallary.store' ) , 'class'=> 'form-horizontal form-material ' , 'files'=>true , 'method'=>'POST' , 'id'=>'user_form')); ?>
