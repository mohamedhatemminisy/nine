            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> 
                     ...
                     <li>
                        ...
                        <a href="#" class="waves-effect  <?php echo e(Request::path() == "$lang/mission"   ? 'active' : ''); ?>  
                                <?php echo e(Request::path() == "$lang/mission/create"   ? 'active' : ''); ?> ">
                                <i class="fa fa-suitcase"></i> 
                                <span class="hide-menu"><?php echo e(trans('about.mission')); ?> 
                                    <span class="fa arrow"></span>
                                </span>
                        </a>

                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo e(route('mission.create')); ?>"><?php echo e(trans('about.create_mission')); ?></a></li>
                            <li><a href="<?php echo e(route('mission.index')); ?>"><?php echo e(trans('about.show_missions')); ?></a></li>
                        </ul>
