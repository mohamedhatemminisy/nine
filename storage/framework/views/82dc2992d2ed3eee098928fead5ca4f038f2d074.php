                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-user animated flipInY">
                                        <li><a href='<?php echo e(url("user/profile/$user->id")); ?>'><i class="ti-user"></i> <?php echo e(trans('profile')); ?></a></li>
                                        ...
                                        <li>
                                               ...
                                               <a href="javascript:{}" onclick="document.getElementById('logout_form').submit();"><i class="fa fa-power-off">  </i> <?php echo e(trans('logout')); ?> 
                                                </a>
